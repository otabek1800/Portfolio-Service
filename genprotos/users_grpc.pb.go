...
type UserServiceClient interface {
	CreateUser(ctx context.Context, in *Users, opts ...grpc.CallOption) (*Void, error)
	DeleteUser(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error)
	UpdateUser(ctx context.Context, in *Users, opts ...grpc.CallOption) (*Void, error)
	GetByIdUser(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Users, error)
	GetAllUser(ctx context.Context, in *Users, opts ...grpc.CallOption) (*GetAllUsers, error)
	LoginUser(ctx context.Context, in *Users, opts ...grpc.CallOption) (*Users, error)
}
...
type UserServiceServer interface {
	CreateUser(context.Context, *Users) (*Void, error)
	DeleteUser(context.Context, *ById) (*Void, error)
	UpdateUser(context.Context, *Users) (*Void, error)
	GetByIdUser(context.Context, *ById) (*Users, error)
	GetAllUser(context.Context, *Users) (*GetAllUsers, error)
	LoginUser(context.Context, *Users) (*Users, error)
...
func (UnimplementedUserServiceServer) CreateUser(context.Context, *Users) (*Void, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateUser not implemented")
}
func (UnimplementedUserServiceServer) DeleteUser(context.Context, *ById) (*Void, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteUser not implemented")
}
func (UnimplementedUserServiceServer) UpdateUser(context.Context, *Users) (*Void, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateUser not implemented")
}
func (UnimplementedUserServiceServer) GetByIdUser(context.Context, *ById) (*Users, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetByIdUser not implemented")
}
func (UnimplementedUserServiceServer) GetAllUser(context.Context, *Users) (*GetAllUsers, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllUser not implemented")
}
func (UnimplementedUserServiceServer) LoginUser(context.Context, *Users) (*Users, error) {
